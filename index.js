...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`994403013485@s.whatsapp.net`]
...
cmhit.push(command)
  ...
  /*const reply = (teks) => {
    ...
    const textImg = (teks) => {
           return ikyy.sendMessage(from, teks, text, {quoted: freply, thumbnail: fs.readFileSync('./YokiGans.jpg')})
        }
const math = (teks) => {
           return Math.floor(teks)
       }
/*const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/994403013485?text=Assalamualaikum`}}})
		}*/
...
const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${senderr.split('@')[0]}:${senderr.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./YokiGans.jpg')
        }}}
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "994403013485-1616169743@g.us",
...
itsmevall.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      itsmevall.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = itsmevall.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '994403013485-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Argio Dev`, "footerText": "*_© Yokiqiwa_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakewa = (teks) => {        
itsmevall.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/994403013485?text=Assalamualaikum`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n𝐄𝐦𝐢𝐥𝐥𝐢𝐚. (@_rxklz) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/994403013485`,
                "mediaType": "10",
                "mediaUrl": `wa.me/994403013485`,
                "thumbnailUrl": "https://j.top4top.io/p_20682m4yj0.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/994403013485`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let _votes = JSON.parse(fs.readFileSync(`./lib/vote/${from}.json`));
        let fil = vote.map((v) => v.participant);
        let id_vote = sender ? sender : "994403013485@s.whatsapp.net";
        if (fil.includes(id_vote)) {
          return mentions(
            "@" + sender.split("@")[0] + " Anda sudah vote",
            fil,
...
*Terimakasih Sudah Mendaftarkan Diri Dalam Database Emillia Bot WhatsApp*
...
*「 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘠𝘰𝘬𝘪𝘘𝘪𝘸𝘢 ☘︎ 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘠𝘰𝘬𝘪𝘲𝘪𝘸𝘢︎', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Terimakasih Telah Mendaftar Di Emillia Bot*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`Hai ${pushname}\n ${ucapanWaktu} Kak 👋`
               ...
               buttons = [{buttonId:`${prefix}yokiqiwa`, 
               buttonText:{displayText: 'MENU シ︎'},type:1},
               {buttonId:`${prefix}owner`,buttonText:{displayText:'CREATOR シ︎'},type:1},
               {buttonId:`${prefix}command`,buttonText:{displayText:'MENU V2シ︎'},type:1}]
...
groups = itsmevall.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "994403013485@s.whatsapp.net"
        dtod = '994403013485'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
𝘽𝙪𝙠𝙖𝙣 𝙋𝙧𝙤𝙜𝙖𝙢𝙢𝙚𝙧, 𝘾𝙪𝙢𝙖𝙣 𝙂𝙖𝙗𝙪𝙩
`
sendButLocation(from, `${menu}`,`𝘽𝙤𝙩 𝘽𝙮 @${dtod.split("@")[0]}`, {jpegThumbnail:iye}, [{buttonId:`${prefix}command`,buttonText:{displayText:'𝙈𝙚𝙣𝙪 シ︎'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
...
case 'bugreport':
              ...
              itsmevall.sendMessage('994403013485@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://instagram.com/rxklz')
break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               ...
               buttons = [{buttonId: `${prefix}mygithub`,buttonText:{displayText: 'WA'},type:1},{buttonId:`${prefix}iggw`,buttonText:{displayText:'INSTAGRAM'},type:1}]
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "thumbnail": fs.readFileSync(`./YokiGans.jpg`),
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘠𝘰𝘬𝘪𝘘𝘪𝘸𝘢 ☘︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
case 'katalog':
    ...
    "listMessage": {
      ...
      "footerText": " 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘠𝘰𝘬𝘪𝘘𝘪𝘸𝘢 ☘︎"
    }
  }, {quoted: freply})
...
case 'script':
		case 'sc':
		case 'sourcecode':
		itsmevall.sendMessage(from, { text: "-", matchedText: 'nopee', description: "", title: "coming soon", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
buttons = [{buttonId: `${prefix}listnulis`,buttonText:{displayText: `List Nulis🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘠𝘰𝘬𝘪𝘘𝘪𝘸𝘢 ☘︎', imageMessage: imageMsg,
              contentText:`𝙎𝙪𝙙𝙖𝙝 𝙎𝙚𝙡𝙚𝙨𝙖𝙞 𝙆𝙖𝙠...☻︎`,buttons,headerType:4}
...
sendButMessage(from, tiyo, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘠𝘰𝘬𝘪𝘘𝘪𝘸𝘢 ☘︎`, [
            {              
...
itsmevall.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./YokiGans.jpg')})
break
case  'blowjob':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
case 'listnulis':
  ...
  🌹 ${prefix}nulis yoki
  🌹 ${prefix}foliokanan yoki
  🌹 ${prefix}foliokiri yoki
  🌹 ${prefix}nuliskanan yoki
  🌹 ${prefix}nuliskiri yoki`)
  break
case 'foliokiri':
if (!c) return reply('Textnya mana gan?')
reply(mess.wait)
...
case 'nsfw':
          ...
          case 'maker2d2': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} Yokiqiwa`)
					makell = args.join(" ")
					reply(mess.wait)
					anu = await fetchJson(`https://api-xchillds.herokuapp.com/api/maker2?text=${makell}&apikey=${xchillds}`)
					buffer1 = await getBuffer(anu.result.results)
					itsmevall.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./YokiGans.jpg')})
					break
		case 'maker2d3': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} Yokiqiwa`)
					makell = args.join(" ")
...
case 'waifu':
          ...
          case 'wallml':
              ...
              buttonsMessage = {footerText:'Dih Wibu Lo Anjing', imageMessage: imageMsg,
  ...
  break
case 'attp':
              if (args.length == 0) return reply(`Example: ${prefix + command} Yokiqiwa`)
